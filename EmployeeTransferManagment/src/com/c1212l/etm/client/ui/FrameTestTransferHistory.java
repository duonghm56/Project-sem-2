 ...
 * @author Luu Bi
 */
public class FrameTestTransferHistory extends javax.swing.JFrame {

    /**
     * Creates new form FrameTestTransferHistory
     */
    public FrameTestTransferHistory() {
        try {
                initComponents();
                initTable();
                lstTransfer = transferHistoryBUS.getTransferHistory();
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("Transfer History"));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrameTestTransferHistory.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrameTestTransferHistory().setVisible(true);
            }
        });
    }
