 ...
 * @author Android21SDK
 */
public class TestEmployeeFrame extends javax.swing.JFrame {

    /**
     * Creates new form TestEmployeeFrame
     */
    public TestEmployeeFrame() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TestEmployeeFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TestEmployeeFrame().setVisible(true);
            }
        });
    }
