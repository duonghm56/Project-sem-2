 ...
 * @author Android21SDK
 */
public class TestTransferPanel extends javax.swing.JFrame {

    /**
     * Creates new form TestTransferPanel
     */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TestTransferPanel.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TestTransferPanel().setVisible(true);
            }
        });
    }
