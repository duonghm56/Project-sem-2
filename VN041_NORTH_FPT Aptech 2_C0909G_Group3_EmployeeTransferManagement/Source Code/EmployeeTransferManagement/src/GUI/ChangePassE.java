 ...
 * @author PROXUANTHI
 */
public class ChangePassE extends javax.swing.JFrame {
    ...
    public void changePassEmployee() {
        ...
        if (!validateInfo.check(oldPass2) || !validateInfo.check(newPass)) {
            ...
            if (!this.getOldPass().equals(oldPass2)) {
                ...
                if (newPass.equals(confirmPass)) {
                    EmployeeDAO.ChangePassWordEmployee(getOldPass(), newPass);
    ...
    private void initComponents() {
        ...
        setTitle("Change pass Employee");

        lblHeader.setFont(new java.awt.Font("Tahoma", 1, 14));
        lblHeader.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        lblHeader.setText("Change pass Employee");
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                new ChangePassE().setVisible(true);
            }
        });
    }
